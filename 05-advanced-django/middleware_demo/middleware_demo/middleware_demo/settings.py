...
SECRET_KEY = 'django-insecure-4kkvl^wqn&f49$)4rw^nnc724c596h@w4-wyam4031#9na*dj@'
...
MIDDLEWARE = [
    ...
    "core.middleware.ViewLoggingMiddleware",
    "core.middleware.TemplateResponseMiddleware",
...
# Logging to show middleware order in console
LOGGING = {
    "version": 1,
